...
local function createModel(opt)
   ...
   model:add(Convolution(3,96,11,11,4,4,2,2))
   model:add(ReLU(true))
   ...
   model:add(Convolution(384,512,3,3,1,1,1,1))
   model:add(ReLU(true))
   model:add(Convolution(512,512,3,3,1,1,1,1))
   model:add(ReLU(true))
   model:add(Avg(11,11,11,11))
   model:add(nn.View(512*1*1))
   model:add(nn.Dropout(0.5))
   model:add(nn.Linear(512*1*1,1000))
